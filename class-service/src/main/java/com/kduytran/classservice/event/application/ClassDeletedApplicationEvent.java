...
@Data
@NoArgsConstructor
public class ClassDeletedApplicationEvent extends AbstractClassApplicationEvent {

    public ClassDeletedApplicationEvent(String transactionId, UUID id, String name, String image,
