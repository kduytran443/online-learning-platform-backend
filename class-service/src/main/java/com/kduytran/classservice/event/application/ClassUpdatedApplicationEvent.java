...
@Data
@NoArgsConstructor
public class ClassUpdatedApplicationEvent extends AbstractClassApplicationEvent {

    public ClassUpdatedApplicationEvent(String transactionId, UUID id, String name, String image,
