...
public class FilterUtility {
    ...
    public ServerWebExchange setCorrelationId(ServerWebExchange exchange, String transactionId) {
        return this.setRequestHeader(exchange, CORRELATION_ID_KEY, transactionId);
    }
