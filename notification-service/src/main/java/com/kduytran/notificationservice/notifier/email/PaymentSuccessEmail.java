...
public class PaymentSuccessEmail extends AbstractEmail {
    public PaymentSuccessEmail(JavaMailSender emailSender, SpringTemplateEngine templateEngine, String subject,
