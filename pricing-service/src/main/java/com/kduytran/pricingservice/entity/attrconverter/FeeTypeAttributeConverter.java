...
import com.kduytran.pricingservice.entity.FeeType;
import jakarta.persistence.AttributeConverter;
import jakarta.persistence.Converter;

@Converter(autoApply = true)
public class FeeTypeAttributeConverter implements AttributeConverter<FeeType, String> {
    /**
