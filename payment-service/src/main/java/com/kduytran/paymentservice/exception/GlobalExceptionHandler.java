...
import com.kduytran.paymentservice.dto.ErrorResponseDTO;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(PayPalTransactionException.class)
    public ResponseEntity<ErrorResponseDTO> handlePayPalTransactionException(
            PayPalTransactionException ex, WebRequest webRequest) {
        return this.getErrorResponseEntity(ex, webRequest, HttpStatus.BAD_REQUEST);
    }
