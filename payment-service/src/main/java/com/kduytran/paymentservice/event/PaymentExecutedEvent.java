...
@NoArgsConstructor
@ToString
public class PaymentExecutedEvent extends AbstractPaymentEvent {

    public PaymentExecutedEvent(UUID transactionId, UUID id, Double total, String currency, UUID orderId,
    ...
    public PaymentEventType getAction() {
        return PaymentEventType.EXECUTE;
    }
}
